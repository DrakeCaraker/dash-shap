...
\midrule
\multirow{4}{*}{0.9}
  & Single Best          & $.960 \pm .005$ & .980 & .218 & .604 \\
  & Large Single Model   & $.940 \pm .007$ & .969 & .254 & .718 \\
  & Stoch.\ Retrain      & $.980 \pm .003$ & .989 & .177 & .584 \\
...
\begin{enumerate}
  ...
  \item \textbf{Equity degrades in the same pattern.}
    ...
    \dash{} distributes it proportionally ($0.150$--$0.166$).
\end{enumerate}
...
\emph{nearly identical} stability ($0.9810$ vs.\ $0.9795$, Cohen's
...
\midrule
\multirow{5}{*}{\rotatebox{90}{\scriptsize Dependent}}
  & Single Best          & $.960 \pm .005$ & .980 & .218 & --- \\
  & Single Best$^\dagger$ & $.962 \pm .005$ & .981 & .213 & --- \\
  & Large Single Model   & $.940 \pm .007$ & .969 & .254 & --- \\
  & LSM (Tuned)          & $.945 \pm .006$ & .972 & .245 & --- \\
  & Ensemble SHAP        & $.962 \pm .005$ & .980 & .232 & --- \\
\midrule
\multirow{4}{*}{\rotatebox{90}{\scriptsize Independent}}
  & Stochastic Retrain   & $.980 \pm .003$ & .989 & .177 & --- \\
  & Random Selection$^\dagger$ & $.978 \pm .003$ & .988 & .175 & --- \\
  & Naive Top-$N$        & $.979 \pm .003$ & .989 & .177 & --- \\
  & \textbf{\dash{} (MaxMin)} & $\mathbf{.981} \pm .003$ & \textbf{.990} & \textbf{.166} & --- \\
\bottomrule
\end{tabular}
\end{table}
