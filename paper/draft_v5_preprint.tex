...
\noindent\textsf{\small This work is licensed under a
\href{https://creativecommons.org/licenses/by/4.0/}{Creative Commons
Attribution 4.0 International License (CC~BY~4.0)}.}%
\footnote{Under review at Transactions on Machine Learning Research (TMLR).}
\vspace{4pt}
...
randomness in data sampling and split selection. We test this hypothesis
empirically in Section~\ref{sec:mechanism_result}.
...
The four principal methods are shown; all nine are compared in Table~\ref{tab:extended}.}
\label{tab:sweep}
\small
...
accounts for $54\%$ of Single Best's total instability but only $24\%$
...
experiments. Even with a tree-count-matched baseline ($M{=}200$ models),
...
We pre-registered eleven pass/fail criteria before running the final
benchmark. These criteria test the paper's stated hypotheses under
