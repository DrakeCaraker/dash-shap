...
\begin{enumerate}
  \item \textbf{Speed.} \dash{} is $1.7\times$ faster than SR (140\,s
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth,alt={Sensitivity plots of stability vs pipeline parameters M, K, epsilon, and delta}]{ablation_sensitivity.png}
...
benchmark. \dash{} passes all eleven: stability wins on $\geq$4/5
$\rhovar$ levels (4/5), accuracy at $\rhovar = 0.9$ exceeds Single Best
($0.988$ vs.\ $0.978$), equity wins on 5/5 $\rhovar$ levels, no
degradation at $\rhovar = 0$ (gap $= 0.0003$), $K_{\text{eff}}$
increases monotonically with $\varepsilon$, nonlinear DGP advantage at
$\rhovar = 0.9$ ($0.873$ vs.\ $0.834$), $\geq$50\% of statistical
tests significant (17/26 Bonferroni, 15/26 Holm--Bonferroni), and
stability improvements on all three real-world datasets. Full
per-criterion details are available in the project repository.
