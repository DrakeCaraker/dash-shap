...
Bonferroni correction on accuracy and equity metrics across all
...
\begin{table}[h]
\centering
\caption{Wilcoxon signed-rank tests with Bonferroni correction
...
\begin{tabular}{clccc}
\toprule
$\rhovar$ & \textbf{Comparison} & \textbf{Metric} & $p_{\text{Bonf}}$ & Cohen's $d$ \\
\midrule
...
\multirow{2}{*}{Breast Cancer}
  & Single Best ($M{=}200$) & $0.317 \pm 0.05$ & ---    & --- \\
...
\midrule
0.0  & 0.9327 & 0.9335 & 0.1784 & \textbf{0.1677} \\
0.5  & 0.8492 & \textbf{0.8520} & 0.1771 & \textbf{0.1724} \\
0.7  & 0.8420 & \textbf{0.8656} & 0.1918 & \textbf{0.1703} \\
0.9  & 0.8336 & \textbf{0.8734} & 0.2002 & \textbf{0.1731} \\
0.95 & 0.7978 & \textbf{0.8758} & 0.2309 & \textbf{0.1665} \\
\bottomrule
\end{tabular}
\end{table}
