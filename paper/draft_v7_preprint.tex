...
\begin{itemize}
  \item \textbf{Scope of the independence principle.} The empirical
    ...
    The conditional SHAP case warrants particular attention: because
    conditional approaches account for feature dependencies in the
    reference distribution \citep{aas2021explaining}, the instability
    dynamics may differ from the interventional setting studied here.
