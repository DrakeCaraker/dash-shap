...
$0.38$ to $0.93$ ($+0.55$) over Single Best, and from
$0.34$ to $0.93$ ($+0.59$) over the training-budget-matched
...
$^\dagger$Matched training budget ($M{=}200$ models trained).
$^*$Superconductor uses 20-rep data pending clean re-run.
$\Delta$Stab.\ is relative to standard Single Best.
Breast Cancer and California Housing sourced from clean 50-rep SageMaker run.}
\label{tab:realworld}
\begin{tabular}{llccc}
\toprule
...
stable top features aligned with known geometric redundancy---\texttt{mean
concave points} (0.228), \texttt{worst area} (0.201), \texttt{worst
perimeter} (0.201)---that are stable across repetitions.
...
from $0.34$ to $0.93$ (Breast Cancer), from $0.83$ to $0.96$
...
\newblock Manuscript in preparation. Lean~4 formalization available at
  \url{https://github.com/DrakeCaraker/dash-impossibility-lean}, 2026.
