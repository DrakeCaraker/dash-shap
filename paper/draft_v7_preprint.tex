...
that screens for instability from one model (no retraining), and a
multi-model attribution $Z$-test that confirms instability with
controlled type~I error.  The FSI and IS~Plot below are exploratory
