...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth,alt={Line plot showing concentration within a correlated group vs number of trees (n\_estimators) for a single sequential model (rising) and an independent ensemble (flat)}]{../results/figures/first_mover_bias_isolation.pdf}
