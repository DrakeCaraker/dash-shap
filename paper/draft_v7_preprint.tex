...
\begin{table}[htbp]
\centering
\caption{Real-world dataset results (50 repetitions each).
...
All results sourced from \texttt{run\_experiments\_parallel.py} (50-rep SageMaker run).}
\label{tab:realworld}
\begin{tabular}{llccc}
\toprule
