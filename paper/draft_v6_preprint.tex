...
$^\dagger$Matched training budget ($M{=}200$ models trained).
$\Delta$Stab.\ is relative to Single Best ($M{=}200$).
...
\multirow{2}{*}{Breast Cancer}
  & Single Best ($M{=}200$)$^\dagger$ & $.317 \pm .053$ & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} \\
  & \textbf{\dash{} (MaxMin)} & $\mathbf{.930} \pm .005$ & $+0.613$ & \multicolumn{1}{c}{---} \\
\addlinespace
\midrule
\addlinespace
...
The training-budget-matched Single Best ($M{=}200$) achieves only
$0.317$ stability, because Breast Cancer's extreme collinearity
...
repetitions, and feature rankings are highly
